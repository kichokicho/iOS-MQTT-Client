...
//            pDataBase = nil;
        ...
        while(sqlite3_step(statement) == SQLITE_ROW) {
            ...
            NSLog(@"getJobList Message : %d, %d, %d, %d, %@, %@, %@, %@, %@, %d", job.jobId,job.msgType,job.ack,job.qos,job.msgId,job.content,job.contentType,job.topic,job.serviceId, job.issueTime);
        }
...
//- (int) getJobId:(NSString *) msgId // Ack 여부
//{
//    //    NSLog(@"======  getAck - Start ");
//    
//    sqlite3_stmt *statement = nil;
